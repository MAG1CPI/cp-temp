SRC_PATH ?= 2022NKUCS-Compilers-Lab/src
INC_PATH += 2022NKUCS-Compilers-Lab/include
BUILD_PATH ?= 2022NKUCS-Compilers-Lab/build
TEST_PATH ?= 2022NKUCS-Compilers-Lab/test/level2-4
OBJ_PATH ?= $(BUILD_PATH)/obj
BINARY ?= $(BUILD_PATH)/compiler
SYSLIB_PATH ?= 2022NKUCS-Compilers-Lab/sysyruntimelibrary
...
$(PARSER):$(BISON)
	@bison -d -o $@ $< --warnings=error=all --defines=$(PARSERH) 
